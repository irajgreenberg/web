...
function VerletStick(n1, n2, stiffness) {
	this.n1 = n1;
	this.n2 = n2;
	this.stiffness = stiffness;

	this.vecOrig = new Vec2(this.n2.pos.x-this.n1.pos.x, this.n2.pos.y-this.n1.pos.y);
	this.len = Math.sqrt((this.n2.pos.x-this.n1.pos.x)*(this.n2.pos.x-this.n1.pos.x), (this.n2.pos.y-this.n1.pos.y)*(this.n2.pos.y-this.n1.pos.y));
};
...
VerletStick.prototype.run = function(){
    this.n1.verlet();
    this.n2.verlet();
    this.constrainLen();
};
